...
def extract_name(client, line):
    ...
    return json.loads(client.ask_question(line.lower(), system_prompt))
...
def process_files():
    ...
    with open('ksr.csv', 'r', newline='', encoding='utf-8') as infile, \
            open('extracted.csv', 'w', newline='', encoding='utf-8') as extracted_file, \
            open('dictionary.csv', 'w', newline='', encoding='utf-8') as dict_file:
